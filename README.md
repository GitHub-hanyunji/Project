[README (3).md](https://github.com/user-attachments/files/25857180/README.3.md)
# BEVFusion on CARLA
...
> 카메라 백본을 **Swin-T → ResNet-50** 으로 교체하여 모델을 경량화하고, **NVIDIA Jetson** Orin 보드 환경에서 실시간 추론을 검증합니다.
...
flowchart LR
    ...
    subgraph JETSON["🖥️ Jetson — Orin-Board"]
        direction TB
        JL["📡 LiDAR"]
        JC["📷 Camera"]
    end
